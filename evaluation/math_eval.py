...
def parse_args():
    ...
    parser.add_argument("--load_in_8bit", action="store_true", help="Load HF model in 8-bit (bitsandbytes) to reduce VRAM.")
    parser.add_argument(
        "--gpu_memory_utilization",
        type=float,
        default=0.9,
        help="vLLM GPU memory utilization ratio (0-1). Lower for small VRAM GPUs.",
    )
    parser.add_argument(
        "--apply_chat_template",
        action="store_true",
...
def setup(args):
    ...
    if args.use_vllm:
        ...
        llm, tokenizer = load_hf_lm_and_tokenizer(
            ...
            load_in_half=not args.load_in_8bit,
